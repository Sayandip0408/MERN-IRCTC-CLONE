...
const Navbar = () => {
    ...
    const list = (anchor) => (
        ...
        >
            <Typography variant='h5' className='mt-3 mb-3 text-center'>Welcome to IRCTC!</Typography>
            {isUser ? <List>
                <ListItemButton className='my-2' onClick={newTicket}>
                    <ListItemIcon sx={{ color: "black" }}>
                        <BookOnlineIcon />
                    </ListItemIcon>
                    <ListItemText primary='BOOK A TICKET' sx={{ color: "black" }} />
                </ListItemButton>
                <ListItemButton className='my-2' onClick={tickets}>
                    <ListItemIcon sx={{ color: "black" }}>
                        <ConfirmationNumberIcon />
                    </ListItemIcon>
                    <ListItemText primary='ALL TICKETS' sx={{ color: "black" }} />
                </ListItemButton>
            ...
            <ThemeProvider theme={theme}>
                <div className="container">
                    <Link to='/account' style={{ textDecoration: "none" }}>
                        <h2 className='text-dark'>IRCTC</h2>
                    </Link>
