    ...
    return (
        <div className='p-3 ticketpage'>
            <div className='container-fluid d-flex justify-content-between'>
                <Link to='/account' style={{ textDecoration: "none", fontSize: "2rem", color: "black", fontWeight: "bold" }}>IRCTC</Link>
            ...
            <div className='container-fluid px-4 py-2' style={{ textAlign: "justify" }}>
                ...
                <div className='row trainDetailsDiv'>
                    <p className='col-xs-12 col-sm-6 text-center border'>Agent Name: SayanDip Adhikary</p>
                    <p className='col-xs-12 col-sm-6 text-center border'>Email ID: sayandip.sp@gmail.com</p>
                </div>
                <div className='row trainDetailsDiv'>
                    <p className='col-xs-12 col-sm-6 text-center border'>Phone No. : 9078123456</p>
                    <p className='col-xs-12 col-sm-6 text-center border'>Email ID: B-121, Sector 5, Noida - 201301</p>
                </div>
                <ul className='mt-4'>
                    <li className='fw-bold'>For details, rules and terms & conditions of E-Ticketing services, please visit www.irctc.co.in</li>
                    ...
                    <li className='fw-bold'>There are amendments in certain provision of Refund Rules. Refer Amended Refund Rules w.e.f 12-Nov- 2015.(details available on www.irctc.co.in under heading Refund Rule--
