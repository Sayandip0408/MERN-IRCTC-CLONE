        ...
        <div className='homepage'>
            ...
            <ThemeProvider theme={theme}>
                <div className='container py-3 userDetailDiv'>
                    <h3 className='text-center'>IRCTC Next-Gen e-Ticketing System</h3>
                    <Links />
                    <div className="bg-dark general-info">
                        You are all set to book your train ticket via IRCTC.<br /><br />
                        <h6>-: NOTE :-</h6>
                        ...
                        <div className='row'>
                            <p className='col-md-4 col-12 text-center'><FaPrayingHands /> শুভ ভ্রমণ <FaPrayingHands /></p>
